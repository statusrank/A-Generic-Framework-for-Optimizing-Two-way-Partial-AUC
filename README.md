...
This is an official implementation with PyTorch, and we run our code on Ubuntu 18.04 server.


# Abstract

![TPAUC](https://github.com/statusrank/A-Generic-Framework-for-Optimizing-Two-way-Partial-AUC/img/TPAUC.png)
...
![Exp](https://github.com/statusrank/A-Generic-Framework-for-Optimizing-Two-way-Partial-AUC/img/Exp.png)
